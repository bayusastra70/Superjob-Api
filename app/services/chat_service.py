        ...
        try:
            ...
            if user_type == "employer":
                ...
                SELECT  
                    ...
                    ct.job_id as job_id,
                    ct.employer_id as sender_id,
                    ct.candidate_id as receiver_id,
                    em.full_name as sender_name,
                    can.full_name as receiver_name,
                ...
                SELECT  
                    ...
                    ct.application_id as application_id,
                    ct.job_id as job_id,
                    ct.employer_id as receiver_id,
                    ct.candidate_id as sender_id,
                    em.full_name as receiver_name,
                    can.full_name as sender_name,
                    j.title as job_title,
                    ct.last_message as last_message,
                    ct.last_message_at as last_message_at,
                    ct.unread_count_employer as unread_count_employer,
